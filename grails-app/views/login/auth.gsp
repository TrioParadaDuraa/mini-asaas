                    ...
                    <div class="inner">
                        ...
                        <atlas-form action="${createLink(controller: 'login', action: 'authenticate')}" method="POST">
                            <atlas-col lg="4" md="3" sm="1">
                                <atlas-masked-input class="email-label" mask-alias="email" label="Email" required="" size="md" placeholder="email@dominio.com" name="username" value="${params.username}"></atlas-masked-input>
                            </atlas-col>
                            <atlas-col lg="4" md="3" sm="1">
